...
int main()
{
    ...
    player1 p1;p1.giveID(1);pl[1]=&p1;
    f[pl[1]->getX()][pl[1]->getY()]=pl[1]->getID();
    pl[1]->init();

    player1 p2;p2.giveID(2);pl[2]=&p2;
    f[pl[2]->getX()][pl[2]->getY()]=pl[2]->getID();
    pl[2]->init();

    player1 p3;p3.giveID(3);pl[3]=&p3;
    f[pl[3]->getX()][pl[3]->getY()]=pl[3]->getID();
    pl[3]->init();

    player1 p4;p4.giveID(4);pl[4]=&p4;
    f[pl[4]->getX()][pl[4]->getY()]=pl[4]->getID();
    pl[4]->init();

    player1 p5;p5.giveID(5);pl[5]=&p5;
    f[pl[5]->getX()][pl[5]->getY()]=pl[5]->getID();
    pl[5]->init();
